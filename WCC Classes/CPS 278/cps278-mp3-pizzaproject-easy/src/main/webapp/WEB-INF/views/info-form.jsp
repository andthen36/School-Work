	...
	<body>
		<div class="form-style-1">
			<form:form action = "processForm" modelAttribute = "order">
				...
				<form:label path="customer.name">Name:<span class = "required">*
				</span>
				</form:label>
				...
				<form:label path="customer.address.street">Street:</form:label>
				<form:input path="customer.address.street"/>
				<form:errors path="customer.address.street" cssClass="error"/>
				<br>
				
				<form:label path="customer.address.city">City:</form:label>
				...
				<form:label path="customer.address.zip">Zip:</form:label>
				...
				<br>
					...
					<tr>
						...
						<td><form:checkboxes path="pizza.toppings" items="${toppingList}"/>
						<br></td>
					</tr>	
